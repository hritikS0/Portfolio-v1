...
export function Navbar() {
  ...
  return (
    ...
    >
            ...
            <AnimatePresence>
              ...
              {isMobileMenuOpen && (
                <motion.div
                  ...
                  className="fixed inset-y-0 right-0 w-64 border-l border-border z-50 flex flex-col p-6 justify-between select-none shadow-2xl"
      ...
      {/* Dynamic Mobile Warning Modal Overlay */}
      <AnimatePresence>
        {showMobileWarning && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 select-none">
            ...
            <motion.div
              ...
              className="relative bg-[#0B0E14] border border-border rounded-xl p-6 max-w-sm w-full text-center space-y-4 shadow-2xl z-50 font-sans"
            >
